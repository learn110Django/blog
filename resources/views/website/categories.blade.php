                    ...
                    <div class="page-scroll-nav psn_single">
                        ...
                        <div class="content-nav_holder">
                            <div class="content-nav">
                                <ul>
                                    <li>
                                        <a href="portfolio-single2.html" class="ln ajax"><i class="fal fa-long-arrow-left"></i><span>Prev <strong>- posts Title</strong></span></a>
                                        <div class="content-nav-media">
                                            <div class="bg"  data-bg="{{url('fronted/images/folio/5.jpg')}}"></div>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="portfolio-single3.html" class="rn ajax"><span >Next <strong>- posts Title</strong></span> <i class="fal fa-long-arrow-right"></i></a>
                                        <div class="content-nav-media">
